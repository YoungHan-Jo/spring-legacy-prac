					...
					<form action="/member/passwd" method="POST" id="contactForm"
						...
						<div class="form-floating mb-3">
							<input class="form-control" id="newPasswd" type="password"
								name="newPasswd" data-sb-validations="required" /> <label for="newPasswd">새 비밀번호</label>
						</div>
						<div class="form-floating mb-3">
							<input class="form-control" id="newPasswdConfirm" type="password"
								name="newPasswdConfirm" data-sb-validations="required" /> <label for="newPasswdConfirm">새 비밀번호 확인</label>
						</div>
